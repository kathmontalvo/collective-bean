        ...
        <>
            <Wrapper>
                ...
                <WrapperWelcome>
                    ...
                    <MainButton as={Link} link={isEnglish ? '/contact/' : '/es/contacto/'}>{WELCOME_CTA}</MainButton>
                </WrapperWelcome>
            </Wrapper>
            <Wrapper>
                <WrapperModel>
            ...
            <Wrapper>
                <WrapperBeans style={{backgroundImage: `url(${BEAN_BG_IMAGE})`}}>
                    <BeanCard className="first" onMouseOver={(e) => changeBgImage(e, BEAN_1_IMG_COLOR)} onMouseLeave={(e) => changeBgImage(e, BEAN_1_IMG_BN)}>
                        ...
                        <ButtonSecondary as={Link} link={ isEnglish ? '/category/coffee-beans/' : '/es/category/cafes/'}>{BEAN_1_CTA}</ButtonSecondary>
                    </BeanCard>
                    <BeanCard className="second" onMouseOver={(e) => changeBgImage(e, BEAN_2_IMG_COLOR)} onMouseLeave={(e) => changeBgImage(e, BEAN_2_IMG_BN)}>
                        ...
                        <ButtonSecondary as={Link} link={isEnglish ? '/category/cacao-beans/' : '/es/category/cacaos/'}>{BEAN_2_CTA}</ButtonSecondary>
                    </BeanCard>
                </WrapperBeans>
            </Wrapper>
        </>
